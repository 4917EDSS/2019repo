...
constexpr double ELEVATOR_MIN_SAFE_HEIGHT = 550;
constexpr double ELEVATOR_MAX_SAFE_HEIGHT = 570;
...
constexpr double ELEVATOR_CARGO_FLOOR_PICKUP_HEIGHT_MM = ELEVATOR_MIN_HEIGHT_MM + 10; // 604.0;
