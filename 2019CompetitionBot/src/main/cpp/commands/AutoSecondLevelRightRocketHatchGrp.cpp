...
AutoSecondLevelRightRocketHatchGrp::AutoSecondLevelRightRocketHatchGrp() {
  ...
  AddSequential(new SilkyMotionCmd(std::vector<double> {550,-550,2800,1500}, std::vector<double> {0,0,48,-20}));
